...
| 단계 | 기간 | 내용 |
|---|---|---|
| 1 | 9.28~10.2 | Astro 뼈대, 디자인 토큰, 네 언어, 자동 점검, 지금 사이트 내용 이전 |
| 2 | 10.5~10.14 | 오프닝 여섯 장면 시제품 |
| 3 | 10.19~10.30 | 제품 화면 HTML 조각, 증빙·신뢰 페이지, 표준 지도, 사례, 문의 |
| 4 | 11.2~11.6 | 번역 검수, 접근성·성능 점검, 도메인 전환 준비 |
